...
export const make_icarus_bootstrap_witness = async (txBodyHash, addr, key) => {
  ...
  const ret = await HaskellShelley.makeIcarusBootstrapWitness(
    txBodyHashPtr,
    addrPtr,
    keyPtr,
  );
...
export class AssetName extends Ptr {
  ...
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.assetNameFromBytes(
      b64FromUint8Array(bytes),
    );
...
export class PublicKey extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.publicKeyFromBytes(
      b64FromUint8Array(bytes),
    );
    return Ptr._wrap(ret, PublicKey);
  }
...
export class PrivateKey extends Ptr {
  ...
  static async from_normal_bytes(bytes) {
    const ret = await HaskellShelley.privateKeyFromNormalBytes(
      b64FromUint8Array(bytes),
    );
  ...
  static async from_extended_bytes(bytes) {
    const ret = await HaskellShelley.privateKeyFromExtendedBytes(
      b64FromUint8Array(bytes),
    );
    return Ptr._wrap(ret, PrivateKey);
  }
   ...
   */
  async sign(message) {
    const ret = await HaskellShelley.privateKeySign(
      this.ptr,
      b64FromUint8Array(message),
    );
...
export class Bip32PublicKey extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.bip32PublicKeyFromBytes(
      b64FromUint8Array(bytes),
    );
    return Ptr._wrap(ret, Bip32PublicKey);
  }
...
export class Bip32PrivateKey extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.bip32PrivateKeyFromBytes(
      b64FromUint8Array(bytes),
    );
    return Ptr._wrap(ret, Bip32PrivateKey);
  }
  ...
  static async from_bip39_entropy(entropy, password) {
    const ret = await HaskellShelley.bip32PrivateKeyFromBip39Entropy(
      b64FromUint8Array(entropy),
      b64FromUint8Array(password),
    );
    return Ptr._wrap(ret, Bip32PrivateKey);
  }
}
...
export class ByronAddress extends Ptr {
  ...
  static async icarus_from_key(key, protocolMagic) {
    ...
    const ret = await HaskellShelley.byronAddressIcarusFromKey(
      keyPtr,
      protocolMagic,
    );
    return Ptr._wrap(ret, ByronAddress);
...
export class Ed25519Signature extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.ed25519SignatureFromBytes(
      b64FromUint8Array(bytes),
    );
    return Ptr._wrap(ret, Ed25519Signature);
  }
...
export class Ed25519KeyHash extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.ed25519KeyHashFromBytes(
      b64FromUint8Array(bytes),
    );
    return Ptr._wrap(ret, Ed25519KeyHash);
  }
...
export class ScriptHash extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.scriptHashFromBytes(
      b64FromUint8Array(bytes),
    );
...
export class ScriptHashes extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.scriptHashesFromBytes(
      b64FromUint8Array(bytes),
    );
...
export class MultiAsset extends Ptr {
  ...
  async insert(key, value) {
    ...
    const ret = await HaskellShelley.multiAssetInsert(
      this.ptr,
      keyPtr,
      valuePtr,
    );
...
export class TransactionHash extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.transactionHashFromBytes(
      b64FromUint8Array(bytes),
    );
    return Ptr._wrap(ret, TransactionHash);
  }
...
export class StakeCredential extends Ptr {
  ...
  static async from_scripthash(hash) {
    ...
    const ret = await HaskellShelley.stakeCredentialFromScriptHash(
      scriptHashPtr,
    );
    return Ptr._wrap(ret, StakeCredential);
  }
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.stakeCredentialFromBytes(
      b64FromUint8Array(bytes),
    );
    return Ptr._wrap(ret, StakeCredential);
  }
...
export class StakeRegistration extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.stakeRegistrationFromBytes(
      b64FromUint8Array(bytes),
    );
  ...
  static async new(stakeCredential) {
    const stakeCredentialPtr = Ptr._assertClass(
      stakeCredential,
      StakeCredential,
    );
...
export class StakeDeregistration extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.stakeDeregistrationFromBytes(
      b64FromUint8Array(bytes),
    );
   ...
   */
  async stake_credential() {
    const ret = await HaskellShelley.stakeDeregistrationStakeCredential(
      this.ptr,
    );
    return Ptr._wrap(ret, StakeCredential);
  }
...
export class StakeDelegation extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.stakeDelegationFromBytes(
      b64FromUint8Array(bytes),
    );
  ...
  static async new(stakeCredential, poolKeyHash) {
    ...
    const ret = await HaskellShelley.stakeDelegationNew(
      stakeCredentialPtr,
      poolKeyHashPtr,
    );
    return Ptr._wrap(ret, StakeDelegation);
...
export class Certificate extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.certificateFromBytes(
      b64FromUint8Array(bytes),
    );
  ...
  static async new_stake_registration(stakeRegistration) {
    const stakeRegistrationPtr = Ptr._assertClass(
      stakeRegistration,
      StakeRegistration,
    );
    const ret = await HaskellShelley.certificateNewStakeRegistration(
      stakeRegistrationPtr,
    );
    return Ptr._wrap(ret, Certificate);
  }
  ...
  static async new_stake_deregistration(stakeDeregistration) {
    const stakeDeregistrationPtr = Ptr._assertClass(
      stakeDeregistration,
      StakeDeregistration,
    );
    const ret = await HaskellShelley.certificateNewStakeDeregistration(
      stakeDeregistrationPtr,
    );
    return Ptr._wrap(ret, Certificate);
  }
  ...
  static async new_stake_delegation(stakeDelegation) {
    const stakeDelegationPtr = Ptr._assertClass(
      stakeDelegation,
      StakeDelegation,
    );
    const ret = await HaskellShelley.certificateNewStakeDelegation(
      stakeDelegationPtr,
    );
    return Ptr._wrap(ret, Certificate);
  }
...
export class Certificates extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.certificatesFromBytes(
      b64FromUint8Array(bytes),
    );
...
export class BaseAddress extends Ptr {
  ...
  static async new(network, payment, stake) {
    ...
    const ret = await HaskellShelley.baseAddressNew(
      network,
      paymentPtr,
      stakePtr,
    );
...
export class UnitInterval extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.unitIntervalFromBytes(
      b64FromUint8Array(bytes),
    );
  ...
  static async new(numerator, denominator) {
    ...
    const ret = await HaskellShelley.unitIntervalNew(
      numeratorPtr,
      denominatorPtr,
    );
    return Ptr._wrap(ret, UnitInterval);
...
export class TransactionInput extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.transactionInputFromBytes(
      b64FromUint8Array(bytes),
    );
  ...
  static async new(transactionId, index) {
    ...
    const ret = await HaskellShelley.transactionInputNew(
      transactionIdPtr,
      index,
    );
    return Ptr._wrap(ret, TransactionInput);
...
export class TransactionOutput extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.transactionOutputFromBytes(
      b64FromUint8Array(bytes),
    );
...
export class Vkeywitness extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.vkeywitnessFromBytes(
      b64FromUint8Array(bytes),
    );
    return Ptr._wrap(ret, Vkeywitness);
  }
...
export class BootstrapWitness extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.bootstrapWitnessFromBytes(
      b64FromUint8Array(bytes),
    );
    return Ptr._wrap(ret, BootstrapWitness);
  }
...
export class TransactionWitnessSet extends Ptr {
  ...
  async set_bootstraps(bootstraps) {
    ...
    return HaskellShelley.transactionWitnessSetSetBootstraps(
      this.ptr,
      bootstrapsPtr,
    );
  }
...
export class TransactionBody extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.transactionBodyFromBytes(
      b64FromUint8Array(bytes),
    );
...
export class Transaction extends Ptr {
  ...
  static async new(body, witnessSet, auxiliary) {
    ...
    if (auxiliary == null) {
      ...
      ret = await HaskellShelley.transactionNewWithAuxiliaryData(
        bodyPtr,
        witnessSetPtr,
        auxiliaryPtr,
      );
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.transactionFromBytes(
      b64FromUint8Array(bytes),
    );
    return Ptr._wrap(ret, Transaction);
  }
...
export class TransactionBuilder extends Ptr {
   ...
   * @returns {Promise<void>}
   */
  async add_bootstrap_input(hash, input, amount) {
   ...
   * @returns {Promise<void>}
   */
  async add_input(address, input, amount) {
  ...
  async set_validity_start_interval(validityStartInterval) {
    return HaskellShelley.transactionBuilderSetValidityStartInterval(
      this.ptr,
  ...
  async set_withdrawals(withdrawals) {
    ...
    return HaskellShelley.transactionBuilderSetWithdrawals(
      this.ptr,
      withdrawalsPtr,
    );
  }
  ...
  async set_auxiliary_data(auxiliary) {
    const auxiliaryPtr = Ptr._assertClass(auxiliary, AuxiliaryData);
    return HaskellShelley.transactionBuilderSetAuxiliaryData(
      this.ptr,
      auxiliaryPtr,
    );
  }
  ...
  async get_explicit_input() {
    const ret = await HaskellShelley.transactionBuilderGetExplicitInput(
      this.ptr,
    );
    return Ptr._wrap(ret, Value);
  }
  ...
  async get_implicit_input() {
    const ret = await HaskellShelley.transactionBuilderGetImplicitInput(
      this.ptr,
    );
    return Ptr._wrap(ret, Value);
  }
  ...
  async get_explicit_output() {
    const ret = await HaskellShelley.transactionBuilderGetExplicitOutput(
      this.ptr,
    );
    return Ptr._wrap(ret, Value);
  }
  ...
  async add_change_if_needed(address) {
    const addressPtr = Ptr._assertClass(address, Address);
    return HaskellShelley.transactionBuilderAddChangeIfNeeded(
      this.ptr,
      addressPtr,
    );
  }
...
export class Withdrawals extends Ptr {
  ...
  async insert(key, value) {
    ...
    const valuePtr = Ptr._assertClass(value, BigNum);
    const ret = await HaskellShelley.withdrawalsInsert(
      this.ptr,
      keyPtr,
      valuePtr,
    );
...
export class MetadataMap extends Ptr {
  ...
  async insert(key, value) {
    ...
    const ret = await HaskellShelley.metadataMapInsert(
      this.ptr,
      keyPtr,
      valuePtr,
    );
...
export class MetadataList extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.metadataListFromBytes(
      b64FromUint8Array(bytes),
    );
    return Ptr._wrap(ret, MetadataList);
  }
...
export class TransactionMetadatum extends Ptr {
  ...
  static async new_list(metadataList) {
    ...
    const ret = await HaskellShelley.transactionMetadatumNewList(
      metadataListPtr,
    );
    return Ptr._wrap(ret, TransactionMetadatum);
  }
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.transactionMetadatumFromBytes(
      b64FromUint8Array(bytes),
    );
    return Ptr._wrap(ret, TransactionMetadatum);
  }
...
export class TransactionMetadatumLabels extends Ptr {
   ...
   */
  async to_bytes() {
    const b64 = await HaskellShelley.transactionMetadatumLabelsToBytes(
      this.ptr,
    );
    return Uint8ArrayFromB64(b64);
  }
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.transactionMetadatumLabelsFromBytes(
      b64FromUint8Array(bytes),
    );
   ...
   */
  async len() {
    return HaskellShelley.transactionMetadatumLabelsLen(this.ptr);
  }
   ...
   */
  async get(index) {
    const ret = await HaskellShelley.transactionMetadatumLabelsGet(
      this.ptr,
      index,
    );
    return Ptr._wrap(ret, TransactionMetadatumLabel);
  }
   ...
   */
  add(item) {
    const itemPtr = Ptr._assertClass(item, BigNum);
...
export class GeneralTransactionMetadata extends Ptr {
   ...
   */
  async to_bytes() {
    const b64 = await HaskellShelley.generalTransactionMetadataToBytes(
      this.ptr,
    );
    return Uint8ArrayFromB64(b64);
  }
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.generalTransactionMetadataFromBytes(
      b64FromUint8Array(bytes),
    );
   ...
   */
  async len() {
    return HaskellShelley.generalTransactionMetadataLen(this.ptr);
  }
  ...
  async insert(key, value) {
    ...
    const valuePtr = Ptr._assertClass(value, TransactionMetadatum);
    const ret = await HaskellShelley.generalTransactionMetadataInsert(
      this.ptr,
      keyPtr,
      valuePtr,
    );
  ...
  async get(key) {
    const keyPtr = Ptr._assertClass(key, TransactionMetadatumLabel);
    const ret = await HaskellShelley.generalTransactionMetadataGet(
      this.ptr,
      keyPtr,
    );
    return Ptr._wrap(ret, TransactionMetadatum);
...
export class AuxiliaryData extends Ptr {
   ...
   */
  static async from_bytes(bytes) {
    const ret = await HaskellShelley.auxiliaryDataFromBytes(
      b64FromUint8Array(bytes),
    );
