...
public class HaskellShelleyModule extends ReactContextBaseJavaModule {
    ...
    // @ReactMethod
    // public final void publicKeyVerify(String pubPtr, String data, String
    // signature, Promise promise) {
    // Native.I
    // .publicKeyVerify(new RPtr(pubPtr), Base64.decode(data, Base64.DEFAULT), new
    // RPtr(signature))
    // .pour(promise);
    // }
    ...
    public final void bip32PrivateKeyFromBip39Entropy(String entropy, String password, Promise promise) {
        Native.I
                .bip32PrivateKeyFromBip39Entropy(Base64.decode(entropy, Base64.DEFAULT),
                        Base64.decode(password, Base64.DEFAULT))
                .map(RPtr::toJs)
                .pour(promise);
    }
    ...
    @ReactMethod
    public final void bootstrapWitnessNew(String vkey, String signature, String chainCode, String attributes,
            Promise promise) {
        Native.I
                .bootstrapWitnessNew(new RPtr(vkey), new RPtr(signature), Base64.decode(chainCode, Base64.DEFAULT),
                        Base64.decode(attributes, Base64.DEFAULT))
                .map(RPtr::toJs)
                .pour(promise);
    }
    ...
    @ReactMethod
    public final void transactionNewWithAuxiliaryData(String body, String witnessSet, String auxiliary,
            Promise promise) {
        Native.I
    ...
    @ReactMethod
    public final void transactionBuilderAddKeyInput(String txBuilder, String hash, String input, String amount,
            Promise promise) {
        Native.I
    ...
    @ReactMethod
    public final void transactionBuilderAddScriptInput(String txBuilder, String hash, String input, String amount,
            Promise promise) {
        Native.I
                .transactionBuilderAddScriptInput(new RPtr(txBuilder), new RPtr(hash), new RPtr(input),
                        new RPtr(amount))
                .pour(promise);
    }

    @ReactMethod
    public final void transactionBuilderAddBootstrapInput(String txBuilder, String hash, String input, String amount,
            Promise promise) {
        Native.I
                .transactionBuilderAddBootstrapInput(new RPtr(txBuilder), new RPtr(hash), new RPtr(input),
                        new RPtr(amount))
                .pour(promise);
    }

    @ReactMethod
    public final void transactionBuilderAddInput(String txBuilder, String address, String input, String amount,
            Promise promise) {
        Native.I
    ...
    @ReactMethod
    public final void transactionBuilderFeeForInput(String txBuilder, String address, String input, String amount,
            Promise promise) {
        Native.I
                .transactionBuilderFeeForInput(new RPtr(txBuilder), new RPtr(address), new RPtr(input),
                        new RPtr(amount))
                .map(RPtr::toJs)
                .pour(promise);
    }
    ...
    @ReactMethod
    public final void transactionBuilderNew(String linearFee, String minimumUtxoVal, String poolDeposit,
            String keyDeposit, Double maxValueSize, Double maxTxSize, Promise promise) {
        Native.I
                .transactionBuilderNew(new RPtr(linearFee), new RPtr(minimumUtxoVal), new RPtr(poolDeposit),
                        new RPtr(keyDeposit), maxValueSize.longValue(), maxTxSize.longValue())
                .map(RPtr::toJs)
                .pour(promise);
    }
    ...
    @ReactMethod
    public final void generalTransactionMetadataInsert(String generalTransactionMetadata, String key, String value,
            Promise promise) {
        Native.I
