...
final class Native {
    ...
    // public final native Result<RPtr> publicKeyVerify(RPtr pubKey, byte[] bytes,
    // RPtr signature);
    ...
    public final native Result<RPtr> bootstrapWitnessNew(RPtr vkey, RPtr signature, byte[] chainCode,
            byte[] attributes);
    ...
    public final native Result<Void> transactionBuilderAddScriptInput(RPtr txBuilder, RPtr hash, RPtr input,
            RPtr value);

    public final native Result<Void> transactionBuilderAddBootstrapInput(RPtr txBuilder, RPtr hash, RPtr input,
            RPtr value);

    public final native Result<Void> transactionBuilderAddInput(RPtr txBuilder, RPtr address, RPtr input, RPtr value);

    public final native Result<RPtr> transactionBuilderFeeForInput(RPtr txBuilder, RPtr address, RPtr input,
            RPtr value);
    ...
    public final native Result<RPtr> transactionBuilderNew(RPtr linearFee, RPtr minimumUtxoVal, RPtr poolDeposit,
            RPtr keyDeposit, long maxValueSize, long maxTxSize);
    ...
    public final native Result<RPtr> generalTransactionMetadataInsert(RPtr generalTransactionMetadata, RPtr key,
            RPtr value);
