...
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_stakeDelegationToBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_stakeDelegationFromBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_stakeDelegationStakeCredential(
  ...
  handle_exception_result(|| {
    ...
    rptr
      ...
      .and_then(|stake_delegation| stake_delegation.stake_credential().rptr().jptr(&env))
  })
  .jresult(&env)
}
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_stakeDelegationPoolKeyhash(
  env: JNIEnv, _: JObject, ptr: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let rptr = ptr.rptr(&env)?;
    rptr
      .typed_ref::<StakeDelegation>()
      .and_then(|stake_delegation| stake_delegation.pool_keyhash().rptr().jptr(&env))
  })
  .jresult(&env)
}
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_stakeDelegationNew(
  ...
  handle_exception_result(|| {
    ...
    stake_credential
      ...
      .and_then(|(stake_credential, pool_keyhash)| {
