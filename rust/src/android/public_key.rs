...
#[no_mangle]
pub extern "C" fn Java_com_fairsupplychain_Native_publicKeyFromBech32(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_publicKeyToBech32(
  env: JNIEnv, _: JObject, public_key: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let public_key = public_key.rptr(&env)?;
    public_key.typed_ref::<PublicKey>().and_then(|public_key| public_key.to_bech32().jstring(&env))
  })
  .jresult(&env)
}
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_publicKeyFromBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_publicKeyAsBytes(
...
// #[allow(non_snake_case)]
// #[no_mangle]
// pub unsafe extern "C" fn Java_com_fairsupplychain_Native_publicKeyVerify(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_publicKeyHash(
  env: JNIEnv, _: JObject, ptr: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let rptr = ptr.rptr(&env)?;
