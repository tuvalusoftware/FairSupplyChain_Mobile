...
use cardano_serialization_lib::{Assets, MultiAsset, PolicyID};
...
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_multiAssetNew(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_multiAssetLen(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_multiAssetInsert(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_multiAssetGet(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_multiAssetKeys(
  env: JNIEnv, _: JObject, multiAsset: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let multiAsset = multiAsset.rptr(&env)?;
    multiAsset.typed_ref::<MultiAsset>().and_then(|multiAsset| multiAsset.keys().rptr().jptr(&env))
  })
  .jresult(&env)
}
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_multiAssetSub(
  ...
  handle_exception_result(|| {
    ...
    rptr
      ...
      .and_then(|res| res.rptr().jptr(&env))
  })
  .jresult(&env)
}
