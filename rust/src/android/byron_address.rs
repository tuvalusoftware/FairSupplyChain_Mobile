...
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_byronAddressToBase58(
...
#[allow(non_snake_case)]
#[no_mangle]
pub extern "C" fn Java_com_fairsupplychain_Native_byronAddressFromBase58(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_byronAddressIsValid(
  env: JNIEnv, _: JObject, string: JString,
) -> jobject {
  handle_exception_result(|| {
    let rstr = string.string(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_byronAddressToAddress(
  env: JNIEnv, _: JObject, ptr: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let rptr = ptr.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_byronAddressFromAddress(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_byronAddressByronProtocolMagic(
  env: JNIEnv, _: JObject, ptr: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let rptr = ptr.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_byronAddressAttributes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_byronAddressIcarusFromKey(
