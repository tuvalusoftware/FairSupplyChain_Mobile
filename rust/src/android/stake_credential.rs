...
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_stakeCredentialFromKeyHash(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_stakeCredentialFromScriptHash(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_stakeCredentialToKeyHash(
  ...
  handle_exception_result(|| {
    ...
    rptr
      ...
      .and_then(|stake_credential| stake_credential.to_keyhash().rptr().jptr(&env))
  })
  .jresult(&env)
}
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_stakeCredentialToScriptHash(
  env: JNIEnv, _: JObject, ptr: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let rptr = ptr.rptr(&env)?;
    rptr
      .typed_ref::<StakeCredential>()
      .and_then(|stake_credential| stake_credential.to_scripthash().rptr().jptr(&env))
  })
  .jresult(&env)
}
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_stakeCredentialKind(
  env: JNIEnv, _: JObject, ptr: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let rptr = ptr.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_stakeCredentialToBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_stakeCredentialFromBytes(
