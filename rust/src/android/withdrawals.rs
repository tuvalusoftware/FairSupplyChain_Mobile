...
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_withdrawalsNew(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_withdrawalsLen(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_withdrawalsInsert(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_withdrawalsGet(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_withdrawalsKeys(
  env: JNIEnv, _: JObject, withdrawals: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let withdrawals = withdrawals.rptr(&env)?;
