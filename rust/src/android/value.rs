...
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_valueNew(
  env: JNIEnv, _: JObject, coin_ptr: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let coin = coin_ptr.rptr(&env)?;
    coin.typed_ref::<Coin>().map(|coin| Value::new(coin)).and_then(|val| val.rptr().jptr(&env))
  })
  .jresult(&env)
}
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_valueCoin(
  env: JNIEnv, _: JObject, value: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let value = value.rptr(&env)?;
    value.typed_ref::<Value>().map(|value| value.coin()).and_then(|coin| coin.rptr().jptr(&env))
  })
  .jresult(&env)
}
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_valueSetCoin(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_valueMultiasset(
  env: JNIEnv, _: JObject, value: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let value = value.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_valueSetMultiasset(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_valueCheckedAdd(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_valueCheckedSub(
  env: JNIEnv, _: JObject, ptr: JRPtr, rhs: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let ptr = ptr.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_valueClampedSub(
  env: JNIEnv, _: JObject, ptr: JRPtr, rhs: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let ptr = ptr.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_valueCompare(
