...
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_bip32PrivateKeyDerive(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_bip32PrivateKeyGenerateEd25519Bip32(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_bip32PrivateKeyToRawKey(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_bip32PrivateKeyToPublic(
  env: JNIEnv, _: JObject, bip_32_private_key: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let bip_32_private_key = bip_32_private_key.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_bip32PrivateKeyFromBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_bip32PrivateKeyAsBytes(
  env: JNIEnv, _: JObject, bip_32_private_key: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let bip_32_private_key = bip_32_private_key.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub extern "C" fn Java_com_fairsupplychain_Native_bip32PrivateKeyFromBech32(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_bip32PrivateKeyToBech32(
  env: JNIEnv, _: JObject, bip_32_private_key: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let bip_32_private_key = bip_32_private_key.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_bip32PrivateKeyFromBip39Entropy(
