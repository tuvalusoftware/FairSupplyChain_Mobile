...
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_transactionMetadatumLabelsToBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_transactionMetadatumLabelsFromBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_transactionMetadatumLabelsNew(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_transactionMetadatumLabelsLen(
  env: JNIEnv, _: JObject, transaction_metadatum_labels: JRPtr,
) -> jobject {
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_transactionMetadatumLabelsGet(
  ...
  handle_exception_result(|| {
    ...
    transaction_metadatum_labels
      .typed_ref::<TransactionMetadatumLabels>()
      .map(|transaction_metadatum_labels| {
        transaction_metadatum_labels.get(usize::from_jlong(index))
      })
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_transactionMetadatumLabelsAdd(
