...
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_addressToBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_addressFromBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_addressToBech32(
  env: JNIEnv, _: JObject, ptr: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let rptr = ptr.rptr(&env)?;
    let val = rptr.typed_ref::<Address>()?;
    val.to_bech32(None).into_result().and_then(|address_str| address_str.jstring(&env))
  })
  .jresult(&env)
}
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_addressToBech32WithPrefix(
  ...
  handle_exception_result(|| {
    ...
    let val = rptr.typed_ref::<Address>()?;
    val.to_bech32(Some(rstr)).into_result().and_then(|address_str| address_str.jstring(&env))
  })
  .jresult(&env)
}
...
#[allow(non_snake_case)]
#[no_mangle]
pub extern "C" fn Java_com_fairsupplychain_Native_addressFromBech32(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_addressNetworkId(
  env: JNIEnv, _: JObject, ptr: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let rptr = ptr.rptr(&env)?;
