...
use cardano_serialization_lib::{AssetName, Assets};
...
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_assetsNew(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_assetsLen(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_assetsInsert(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_assetsGet(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_assetsKeys(
  env: JNIEnv, _: JObject, assets: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let assets = assets.rptr(&env)?;
    assets.typed_ref::<Assets>().and_then(|assets| assets.keys().rptr().jptr(&env))
  })
  .jresult(&env)
}
