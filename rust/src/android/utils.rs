...
use cardano_serialization_lib::metadata::{
  decode_metadatum_to_json_str, encode_json_str_to_metadatum, MetadataJsonSchema,
  TransactionMetadatum,
};
use cardano_serialization_lib::utils::{
  hash_transaction, make_icarus_bootstrap_witness, make_vkey_witness, min_ada_required, BigNum,
  Value,
};
...
pub unsafe fn to_bytes<T: RPtrRepresentable + ToFromBytes>(env: JNIEnv, obj: JRPtr) -> jobject {
...
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_makeIcarusBootstrapWitness(
  ...
  handle_exception_result(|| {
    ...
    tx_body_hash
      ...
      .and_then(|((tx_body_hash, addr), key)| {
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_makeVkeyWitness(
  ...
  handle_exception_result(|| {
    ...
    tx_body_hash
      ...
      .and_then(|(tx_body_hash, sk)| make_vkey_witness(tx_body_hash, sk).rptr().jptr(&env))
  })
  .jresult(&env)
}
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_hashTransaction(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_minAdaRequired(
  ...
  handle_exception_result(|| {
    ...
    //   |(assets, minimum_utxo_val)| min_ada_required(assets, minimum_utxo_val).rptr().jptr(&env),
    // )
    Ok(JObject::null())
  })
  .jresult(&env)
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_encodeJsonStrToMetadatum(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_decodeMetadatumToJsonStr(
  ...
  handle_exception_result(|| {
    ...
    metadatum
      .typed_ref::<TransactionMetadatum>()
      .and_then(|metadatum| decode_metadatum_to_json_str(metadatum, schema_enum).into_result())
