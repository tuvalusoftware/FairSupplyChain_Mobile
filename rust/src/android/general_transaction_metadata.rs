...
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_generalTransactionMetadataToBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_generalTransactionMetadataFromBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_generalTransactionMetadataNew(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_generalTransactionMetadataLen(
  env: JNIEnv, _: JObject, general_transaction_metadata: JRPtr,
) -> jobject {
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_generalTransactionMetadataInsert(
  ...
  handle_exception_result(|| {
    ...
    general_transaction_metadata
      ...
      .map(|((general_transaction_metadata, key), value)| {
        general_transaction_metadata.insert(key, value)
      })
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_generalTransactionMetadataGet(
  ...
  handle_exception_result(|| {
    ...
    general_transaction_metadata
      .typed_ref::<GeneralTransactionMetadata>()
      .zip(key.typed_ref::<TransactionMetadatumLabel>())
      .and_then(|(general_transaction_metadata, key)| {
        general_transaction_metadata.get(key).rptr().jptr(&env)
      })
  })
  .jresult(&env)
}
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_generalTransactionMetadataKeys(
  env: JNIEnv, _: JObject, general_transaction_metadata: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let general_transaction_metadata = general_transaction_metadata.rptr(&env)?;
    general_transaction_metadata.typed_ref::<GeneralTransactionMetadata>().and_then(
      |general_transaction_metadata| general_transaction_metadata.keys().rptr().jptr(&env),
    )
  })
  .jresult(&env)
}
