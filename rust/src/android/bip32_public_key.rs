...
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_bip32PublicKeyDerive(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_bip32PublicKeyToRawKey(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_bip32PublicKeyFromBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_bip32PublicKeyAsBytes(
  env: JNIEnv, _: JObject, bip32_public_key: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let bip32_public_key = bip32_public_key.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub extern "C" fn Java_com_fairsupplychain_Native_bip32PublicKeyFromBech32(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_bip32PublicKeyToBech32(
  env: JNIEnv, _: JObject, bip32_public_key: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let bip32_public_key = bip32_public_key.rptr(&env)?;
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_bip32PublicKeyChaincode(
  env: JNIEnv, _: JObject, bip32_public_key: JRPtr,
) -> jobject {
  handle_exception_result(|| {
    let bip32_public_key = bip32_public_key.rptr(&env)?;
