...
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_assetNameToBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_assetNameFromBytes(
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_assetNameNew(
  env: JNIEnv, _: JObject, bytes: jbyteArray,
) -> jobject {
...
#[allow(non_snake_case)]
#[no_mangle]
pub unsafe extern "C" fn Java_com_fairsupplychain_Native_assetNameName(
  env: JNIEnv, _: JObject, asset_name: JRPtr,
) -> jobject {
  handle_exception_result(|| {
